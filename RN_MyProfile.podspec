...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/192.168.0.222/RN_MyProfile'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { '192.168.0.222' => 'myloveiscodejie@163.com' }
  s.source           = { :git => 'https://github.com/192.168.0.222/RN_MyProfile.git', :tag => s.version.to_s }
  ...
  # s.resource_bundles = {
  #   'RN_MyProfile' => ['RN_MyProfile/Assets/*.png']
  # }
